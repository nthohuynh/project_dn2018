...
import lzcompression.control.Controller;
import lzcompression.control.LZCompressionOutInterceptor;
...
public class LZCompression {
	...
	public LZCompression() {
		System.out.println("start LZCompression");
		...
		svrFactory.setAddress("udp://192.168.56.2:9001/lzcompression"); //on window xp
		svrFactory.setServiceBean(sendingImpl);
		svrFactory.getOutInterceptors().add(new LZCompressionOutInterceptor());
...
//								System.out.println("start to treat the msgs in LZCompression");
