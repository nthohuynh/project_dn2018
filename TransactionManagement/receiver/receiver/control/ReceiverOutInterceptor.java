...
public class ReceiverOutInterceptor extends AbstractSoapInterceptor {
	String transactionID;
	public ReceiverOutInterceptor() {
	...
	public void handleMessage(SoapMessage paramT) throws Fault {
		...
		try {
			transactionID = ReceiverInInterceptor.transactionID;
