...
public class MyConduit extends AbstractConduit {
    ...
    private static final String HOST_PORT = MyConduit.class + ".host:port";
    ...
    public MyConduit(EndpointReferenceType t, final Bus bus) {
        super(t);
        this.bus = bus;
...
//		}
		...
		byte b = buffer[i];
		if (b > 31 && b < 126)
			System.out.println(i+":"+Character.toString((char) b));
		}	
		//////////////////
