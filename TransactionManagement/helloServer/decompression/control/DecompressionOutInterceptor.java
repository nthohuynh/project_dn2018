...
public class DecompressionOutInterceptor extends AbstractSoapInterceptor {
	String transactionID;
	public DecompressionOutInterceptor() {
	...
	public void handleMessage(SoapMessage paramT) throws Fault {
		...
		try {
			transactionID = DecompressionInInterceptor.transactionID;
